...
(* OASIS_START *)
(* DO NOT EDIT (digest: 71527f3986d55b269ee9b96c3ce4ca73) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Peter Huang"];
          homepage = None;
          synopsis = "the ocaml push server";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\"~\015\206\210\210\152]\012\244dG\141S\172\171";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
